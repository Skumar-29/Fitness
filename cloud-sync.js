...
async function deleteCloudData(){
  if(!user||!confirm(text('Delete all synced Fitness V6.1 data from the cloud? Local data on this device will remain.','क्लाउड से सभी सिंक Fitness V6.1 डेटा हटाएँ? इस डिवाइस का स्थानीय डेटा रहेगा।')))return;
...
async function deleteAccount(){
  if(!user||!confirm(text('Permanently delete this Fitness V6.1 account and all synced cloud data? Local data on this device will remain until you reset it separately.','इस Fitness V6.1 खाते और सभी सिंक क्लाउड डेटा को स्थायी रूप से हटाएँ? इस डिवाइस का स्थानीय डेटा अलग से रीसेट करने तक रहेगा।')))return;

(() => {
  ...
  const PREF_KEY = 'fitnessV3Preferences';
  const DEFAULT_PREFS = {
    language: 'en',
    voiceGuide: 'full',
    voiceGender: 'auto',
  ...
  const EXACT_HI = {
    'Health App': 'फिटनेस V3', 'Fitness V3': 'फिटनेस V3', 'Complete body training': 'संपूर्ण शरीर प्रशिक्षण', 'Offline ready': 'ऑफलाइन तैयार', 'Online': 'ऑनलाइन',
    ...
    'Safety screening': 'सुरक्षा जाँच', 'Install Health App': 'फिटनेस V3 इंस्टॉल करें', 'Check for update': 'अपडेट जाँचें', 'Export backup': 'बैकअप निर्यात करें', 'Import backup': 'बैकअप आयात करें', 'Reset app data': 'ऐप डेटा रीसेट करें',
  ...
  function applyLanguage(root = document.body) {
    ...
    document.title = prefs.language === 'hi' ? 'फिटनेस V3' : 'Fitness V3';
  ...
  function createV3Controls() {
    ...
    document.getElementById('v3PreviewVoice').addEventListener('click', () => {
      speak(prefs.language === 'hi' ? 'नमस्ते। आपका फिटनेस वॉइस कोच तैयार है।' : 'Hello. Your Fitness V3 voice coach is ready.', {interrupt:true});
    });
  }
  ...
  function boot() {
    document.querySelector('.brand-button strong').textContent = 'Fitness V3';
    ...
    const badge = document.getElementById('appVersion'); if (badge) badge.textContent = 'fitness-v3.0.0';
    createV3Controls();
    enhancePlayer();
    bindCoachEvents();
    refreshVoices();
